...
public function xeName($code){
    
    return $this->xeCurrency($code,'majorSingle');
    
    
}
    
public function xeSym($code){
    
    return $this->xeCurrency($code,'symbol');
    
    
}
    
public function xeSymN($code){
    
    return $this->xeCurrency($code,'symbolNative');
    
    
}
    
public function xefmt($code){
    
    return $this->xeCurrency($code,'ISOdigits');
    
    
}
    
public function xeDecimal($code){
    
    return $this->xeCurrency($code,'decimal');
    
    
}
    
    
public function xeCurrency($cod,$f){
